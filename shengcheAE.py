...
def plot_images(image, noise, noisy_image,
                name_source, name_target,
                score_source, score_source_org, score_target,q):
    """
   ...
   # msg = "Original Image:\n{0} ({1:.2%})"
    ...
    plt.imshow(noisy_image / 255.0, interpolation=interpolation)
    plt.axis('off')
    #plt.imshow(noisy_image / 255.0)
    save_path="images/"+str(q)+"_.png"
